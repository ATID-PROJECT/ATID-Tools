...
class group_quiz_manager extends external_api {


    public static function group_quiz_parameters() {
        return new external_function_parameters(
            array(
                  'quiz_id' => new external_value(PARAM_TEXT, 'quiz id,', VALUE_DEFAULT, 'Hello world, '),
    ...
    public static function group_quiz($quiz_id=0,$course_id=1, $group_id=1) {

        global $COURSE, $DB;

        $params = self::validate_parameters(self::group_quiz_parameters(),
        ...
        $cm = get_coursemodule_from_instance('quiz', $quiz_id, $instance->course);
     ...
     */
    public static function group_quiz_returns() {
