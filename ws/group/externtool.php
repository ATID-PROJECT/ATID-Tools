...
class group_lti_manager extends external_api {


    public static function group_lti_parameters() {
        return new external_function_parameters(
            array(
                  'lti_id' => new external_value(PARAM_TEXT, 'lti id,', VALUE_DEFAULT, 'Hello world, '),
    ...
    public static function group_lti($lti_id=0,$course_id=1, $group_id=1) {

        global $COURSE, $DB;

        $params = self::validate_parameters(self::group_lti_parameters(),
        ...
        $cm = get_coursemodule_from_instance('lti', $lti_id, $instance->course);
     ...
     */
    public static function group_lti_returns() {
