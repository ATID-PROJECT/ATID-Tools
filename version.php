...
$plugin->version  = 2011101511;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->requires = 2010112402;  // Requires this Moodle version - at least 2.0
$plugin->component = 'local_wstemplate';
$plugin->cron     = 0;
$plugin->release = '1.0 (Build: 2011101312)';
$plugin->maturity = 1;
